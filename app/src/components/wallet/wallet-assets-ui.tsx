...
export function EmptyState({ icon, title, description }: { icon: ReactNode; title: string; description: string }) { return <div className="flex min-h-64 flex-col items-center justify-center rounded-[16px] border border-[#040d09] bg-[#0e0e10]/80 px-6 text-center"><span className="text-zinc-600">{icon}</span><h2 className="mt-3 text-base">{title}</h2><p className="mt-2 text-sm text-zinc-500">{description}</p></div>; }
