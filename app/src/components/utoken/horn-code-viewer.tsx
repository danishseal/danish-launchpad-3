  ...
  return (
    <div className="overflow-hidden rounded-xl border border-[#1e1e22] bg-[#0c0c0e]">
      ...
      <div className="max-h-[68vh] overflow-auto">
        {error ? (
          <p className="px-4 py-10 text-center text-[13px] text-zinc-500">Source unavailable.</p>
        ) : !code ? (
          <p className="px-4 py-10 text-center font-mono text-[12px] text-zinc-600">Loading source…</p>
        ) : (
            ...
            {lines.map((ln, i) => {
              ...
              return (
                <div key={i} className="flex hover:bg-white/[0.02]">
                  <span
                    className="sticky left-0 z-10 select-none border-r border-[#17171a] bg-[#0c0c0e] px-3 text-right text-[11px] text-zinc-700"
