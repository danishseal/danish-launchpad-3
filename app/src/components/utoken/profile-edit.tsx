...
export function ProfileEditModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 backdrop-blur-sm" onClick={onClose}>
      <div className="max-h-[90vh] w-full max-w-md overflow-y-auto rounded-2xl border border-[var(--hairline-strong)] bg-[#030806] shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-[var(--hairline)] bg-[#030806] px-5 py-3.5">
        ...
        <div className="space-y-4 p-5">
          ...
          <Labeled label="Username">
            <div
              className={`flex h-10 items-center rounded-lg border bg-[#061109] px-3 ${
                usernameError
                  ? "border-red-500/60"
        ...
        <div className="sticky bottom-0 flex justify-end gap-2 border-t border-[var(--hairline)] bg-[#030806] px-5 py-3.5">
...
function ProfileImages({
  ...
  return (
    <div>
      <span className="mb-1.5 block text-[12px] font-medium text-zinc-400">Banner</span>
      ...
      <div className="relative">
        <button
          ...
          className={`group relative block aspect-[3.8/1] w-full overflow-hidden rounded-xl border bg-[#061109] transition-colors ${bannerDrag ? "border-[#00f090] ring-2 ring-[#00f090]" : "border-[var(--hairline)]"}`}
        >
          {banner ? (
        ...
        <button
          ...
          className={`group absolute -bottom-8 left-4 h-20 w-20 overflow-hidden rounded-full border-2 border-[#030806] bg-[#061109] ring-4 transition-colors ${avatarDrag ? "ring-[#00f090]" : "ring-[#030806]"}`}
        >
          {avatar ? (
            // eslint-disable-next-line @next/next/no-img-element
      ...
      <div className="mt-2.5 flex items-center gap-3 pl-[108px]">
        ...
        {avatar && (
          <button type="button" onClick={() => onAvatar("")} className="inline-flex items-center gap-1 text-[11px] text-zinc-500 hover:text-[#ff5b5b]">
            <Trash size={12} /> Remove
          </button>
        )}
      </div>
