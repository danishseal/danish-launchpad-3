...
export function TradingChart({
  ...
  return (
    ...
    >
      ...
      {chartData ? (
        <div className={terminal ? "overflow-hidden border-0 bg-transparent" : "overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm"}>
          <TradingChartCanvas
            data={chartData}
        ...
        >
          <div className="text-center space-y-2">
            <p className={terminal ? "text-zinc-400" : "text-zinc-500"}>
              No trading data available yet
            </p>
            <p className={terminal ? "text-sm text-zinc-500" : "text-sm text-zinc-600"}>
