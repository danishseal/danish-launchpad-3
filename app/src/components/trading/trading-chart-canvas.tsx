  ...
  return (
    <div>
      ...
      <div className="flex min-h-[28px] flex-wrap items-center gap-x-3 gap-y-0.5 px-3 pt-2 pb-0.5 font-mono text-xs">
        <span className={terminal ? "font-sans text-[11px] font-medium text-zinc-500" : "text-muted-foreground font-sans text-[11px] font-medium"}>
        ...
        {displayedLegend && (
          <>
            <span>
              ...
              <span className={terminal ? "text-zinc-200" : up ? "text-blue-600" : "text-zinc-700"}>
                {formatChartPrice(displayedLegend.open)}
              </span>
            </span>
            <span>
              <span className="text-muted-foreground">H</span>
              <span className={terminal ? "text-zinc-200" : "text-blue-600"}>
                {formatChartPrice(displayedLegend.high)}
              </span>
            </span>
            <span>
              <span className="text-muted-foreground">L</span>
              <span className={terminal ? "text-zinc-200" : "text-zinc-700"}>
      ...
      {displayedLegend && indicators.volume && (
        <div className="px-3 pb-1 text-xs font-mono">
          <span className={terminal ? "font-sans text-[11px] text-zinc-500" : "text-muted-foreground font-sans text-[11px]"}>
            Volume
          </span>{" "}
          <span className={terminal ? "text-zinc-300" : "text-blue-500"}>
