  ...
  return (
    <div className="space-y-2 rounded-xl border border-zinc-200 bg-zinc-50 p-4 text-sm">
      ...
      <div className="flex justify-between">
        ...
        <span className="font-mono text-zinc-900">{feeUsd}</span>
      </div>
      {priceImpact && (
        <div className="flex justify-between">
          <span className="text-zinc-500">Price impact</span>
          <span className="font-mono text-zinc-900">{priceImpact}%</span>
        </div>
      )}
      {newPriceUsd && (
        <div className="flex justify-between">
          <span className="text-zinc-500">New price</span>
          <span className="font-mono text-zinc-900">{newPriceUsd}</span>
        </div>
      )}
    </div>
  );
