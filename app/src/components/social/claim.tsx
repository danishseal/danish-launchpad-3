        ...
        {wallet.address ? (
          <>
            <p className="mt-2.5 truncate text-[12px] text-zinc-500">
              Wallet connected: <span className="font-mono text-zinc-400">{wallet.address}</span>
            </p>
            <button
              type="button"
            ...
            <button
              ...
              disabled={claiming}
              className="mt-2 inline-flex h-10 w-full items-center justify-center rounded-lg border border-[var(--hairline)] bg-transparent text-[13px] font-medium text-zinc-300 transition-colors hover:border-[var(--hairline-strong)] hover:text-white disabled:opacity-60"
            >
    ...
    <div className="mx-auto w-full max-w-md">
      <div className="rounded-2xl border border-[var(--hairline)] bg-[#030806] p-5">
        ...
        <div className="mt-5 space-y-4">
          {/* Banner + avatar */}
          <div>
            <span className="mb-1.5 block text-[12px] font-medium text-zinc-400">Banner &amp; avatar</span>
            ...
            <div className="mt-2.5 pl-[108px] text-[11px] text-zinc-600">
          ...
          <label className="block">
            <span className="mb-1.5 block text-[12px] font-medium text-zinc-400">Display name</span>
        ...
        <div className="mt-5 border-t border-[var(--hairline)] pt-5">
          ...
          {wallet.address && (
            <p className="mt-2 truncate text-center text-[11px] text-zinc-500">
              Binding <span className="font-mono text-zinc-400">{wallet.address}</span>
            </p>
          )}
        </div>
      </div>
