      ...
      {holdings.data && holdings.data.length > 0 && (
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
          {holdings.data.map((token) => (
            <Link key={token.mint} href={`/token/${token.market}`} className="group rounded-[16px] border border-[#040d09] bg-[#020604] p-4 transition-colors hover:border-[#57575e]">
              ...
              <div className="mt-5 border-t border-[#040d09] pt-4">
